...
| [authService.js](../../../apps/frontend/src/api/authService.js) | Axios instance (đính Bearer token, auto-refresh 401) — được `adminService.js` import (đã phân tích chi tiết ở `student-management-feature-analysis.md`) | Axios Config / Auth |
