...
public enum TargetStatus {
    ...
    public static TargetStatus fromValue(String raw) {
        if (raw != null) {
            for (TargetStatus t : values()) {
        ...
        throw new BusinessException(
                400, "VALIDATION_FAILED", "Trạng thái đích không hợp lệ (chỉ unpublished/archived/deleted): " + raw);
    }
}
