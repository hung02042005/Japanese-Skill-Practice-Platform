...
import { WaveIcon } from '@/shared/components/common/AppIcons';
import { fetchReviewQueueThunk } from '@/features/management/managerReviewSlice';
import { fetchPublishedContentsThunk } from '@/features/management/publishedContentSlice';
    ...
    <div className="mgd-page">
      ...
      <main className="mgd-body">
        ...
        <div className="mgd-actions-grid">
          ...
          <Link to="/manager/deleted-topics" className="mgd-action-card mgd-action-card--green">
            <div className="mgd-action-icon">
              <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
            ...
            <div>
              <p className="mgd-action-title">Thư mục đã xóa</p>
              <p className="mgd-action-desc">Xem và khôi phục chủ đề từ vựng</p>
            </div>
          </Link>
        </div>
