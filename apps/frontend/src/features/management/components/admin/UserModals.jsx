...
import { StarIcon } from '@/shared/components/common/StudentIcons';
import { CheckCircleIcon, KeyIcon, TrashIcon, LockIcon, LeafIcon, PencilIcon } from '@/shared/components/common/AppIcons';
