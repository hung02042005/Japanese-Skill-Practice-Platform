...
import { getDashboard, getVocabHome, getCourses } from '@/shared/api/studentService';
...
const DEMO = {
  ...
  lessons: [
    ...
    { id: 18, title: 'Luyện nói N5', description: 'Luyện phát âm & hội thoại AI N5', jlptLevel: 'N5', lessonType: 'SPEAKING', status: 'available', progress: 0, thumbnail: '言' },
    // ── N4 ──
    ...
    { id: 20, title: 'Luyện nói N4', description: 'Luyện giao tiếp & phát âm AI N4', jlptLevel: 'N4', lessonType: 'SPEAKING', status: 'available', progress: 0, thumbnail: '言' },
    // ── N3 ──
    ...
    { id: 22, title: 'Luyện nói N3', description: 'Hội thoại tình huống & phản xạ N3', jlptLevel: 'N3', lessonType: 'SPEAKING', status: 'available', progress: 0, thumbnail: '言' },
    // ── N2 ──
    ...
    { id: 24, title: 'Luyện nói N2', description: 'Thuyết trình & giao tiếp nâng cao N2', jlptLevel: 'N2', lessonType: 'SPEAKING', status: 'available', progress: 0, thumbnail: '言' },
    // ── N1 ──
    ...
    { id: 27, title: 'Luyện nói N1', description: 'Phát biểu & tranh luận chuyên sâu N1', jlptLevel: 'N1', lessonType: 'SPEAKING', status: 'available', progress: 0, thumbnail: '言' },
  ],
  wordCount: 248,
  daysThisMonth: 18,
};
