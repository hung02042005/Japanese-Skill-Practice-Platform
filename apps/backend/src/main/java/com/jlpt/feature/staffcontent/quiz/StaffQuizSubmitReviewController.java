...
import com.jlpt.feature.staffcontent.exam.StaffExamService;
import com.jlpt.feature.staffcontent.grammar.StaffGrammarService;
import com.jlpt.feature.staffcontent.grammar.dto.GrammarSubmitReviewResponse;
import com.jlpt.feature.staffcontent.learning.LearningContentService;
...
public class StaffQuizSubmitReviewController {
    ...
    public ResponseEntity<ApiResponse<QuizSubmitReviewResponse>> submitReview(
        ...
        return ResponseEntity.badRequest()
                .body(ApiResponse.<QuizSubmitReviewResponse>builder()
                        .status(400)
                        .message("contentType không hợp lệ. Hỗ trợ: assessment, exam, lesson, vocabulary, kanji")
                        .build());
    }
}
