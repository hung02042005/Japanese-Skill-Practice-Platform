...
public class AdminNotificationRuleController {
    ...
    public ResponseEntity<ApiResponse<Void>> delete(
            Authentication authentication, @PathVariable String ruleKey) {
        notificationRuleService.deleteRule(ruleKey, currentAdminId(authentication));
        return ResponseEntity.ok(ApiResponse.success("Da vo hieu hoa quy tac thong bao", null));
    }
