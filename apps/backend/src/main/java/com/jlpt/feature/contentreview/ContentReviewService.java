...
public class ContentReviewService {
    ...
    public ReviewQueueResponse getReviewQueue(
        ...
        List<ReviewQueueItemResponse> content =
                all.subList(from, to).stream().map(this::toQueueItem).toList();
    ...
    private ReviewQueueItemResponse toQueueItem(ContentSnapshot s) {
        return ReviewQueueItemResponse.builder()
                ...
                .submittedBy(s.getCreatedByName())
                .submittedById(s.getCreatedById())
