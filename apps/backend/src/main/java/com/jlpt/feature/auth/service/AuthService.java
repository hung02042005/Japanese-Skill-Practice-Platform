...
import com.jlpt.feature.auth.dto.GoogleTokenRequest;
import com.jlpt.feature.auth.dto.LoginRequest;
import com.jlpt.feature.auth.dto.RegisterRequest;
import com.jlpt.feature.auth.dto.AccountTypeResponse;
import com.jlpt.feature.auth.dto.AuthResponse;
import com.jlpt.feature.auth.dto.LoginApiResponse;
import com.jlpt.feature.auth.dto.StudentResponse;
...
public class AuthService {
    ...
    @Transactional
    public com.jlpt.feature.auth.dto.RefreshTokenResponse refresh(com.jlpt.feature.auth.dto.RefreshTokenRequest request) {
        ...
        return com.jlpt.feature.auth.dto.RefreshTokenResponse.builder()
    ...
    @Transactional
    public void logout(com.jlpt.feature.auth.dto.LogoutRequest request) {
    ...
    @Transactional
    public void verifyEmail(com.jlpt.feature.auth.dto.VerifyEmailRequest request) {
        AuthToken tokenEntity = authTokenRepository
    ...
    @Transactional
    public void resendVerification(com.jlpt.feature.auth.dto.ResendVerificationRequest request) {
        StudentUser user = studentUserRepository
                .findByEmail(request.getEmail())
                .orElseThrow(() -> new BusinessException(404, "USER_NOT_FOUND", "Người dùng không tồn tại"));
    ...
    @Transactional
    public void forgotPassword(com.jlpt.feature.auth.dto.ForgotPasswordRequest request) {
        StudentUser user = studentUserRepository
                .findByEmail(request.getEmail())
                .orElseThrow(() -> new BusinessException(404, "USER_NOT_FOUND", "Người dùng không tồn tại"));
    ...
    @Transactional
    public void resetPassword(com.jlpt.feature.auth.dto.ResetPasswordRequest request) {
    ...
    @Transactional
    public StudentResponse updateProfile(Long studentId, com.jlpt.feature.auth.dto.UpdateProfileRequest request) {
        StudentUser user = studentUserRepository
                .findById(studentId)
                .orElseThrow(() -> new BusinessException(404, "USER_NOT_FOUND", "Người dùng không tồn tại"));
    ...
    @Transactional
    public void changePassword(Long studentId, com.jlpt.feature.auth.dto.ChangePasswordRequest request) {
        if (!request.getNewPassword().equals(request.getConfirmPassword())) {
            throw new BusinessException(400, "PASSWORD_MISMATCH", "Mật khẩu xác nhận không khớp");
        }
