...
package com.jlpt.flashcard.repository;
...
public interface FlashcardRepository extends JpaRepository<Flashcard, Long> {
    ...
    @Query(
            ...
            WHERE f.student.id = :studentId
              AND f.deck.id = :deckId
              AND f.contentType = com.jlpt.entity.Flashcard$ContentType.VOCABULARY
              AND f.lastRating = com.jlpt.entity.Flashcard$LastRating.WRONG
