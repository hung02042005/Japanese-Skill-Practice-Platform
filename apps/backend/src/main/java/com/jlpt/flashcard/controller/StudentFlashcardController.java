...
package com.jlpt.flashcard.controller;

import com.jlpt.common.ApiResponse;
import com.jlpt.flashcard.dto.AddFlashcardRequest;
import com.jlpt.flashcard.dto.DeckCreateRequest;
...
import com.jlpt.flashcard.service.FlashcardSrsService;
...
public class StudentFlashcardController {
    ...
    public ResponseEntity<ApiResponse<Page<FlashcardResponse>>> getCards(
            ...
            @PageableDefault(size = 20, sort = "nextReviewDate") Pageable pageable) {
        Page<FlashcardResponse> cards =
                flashcardSrsService.getCards(userDetails.getStudentUser().getId(), deckId, dueOnly, pageable);
        return ResponseEntity.ok(ApiResponse.success(cards));
    }

    /** Phiên học trộn (§3.6/§3.7): ?deckId=… HOẶC ?level=N5&topic=…&newLimit=10. */
    @GetMapping("/flashcards/session")
