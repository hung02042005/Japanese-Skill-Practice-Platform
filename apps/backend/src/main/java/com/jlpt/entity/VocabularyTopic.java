...
@Table(
        ...
        uniqueConstraints = {
            @UniqueConstraint(name = "UQ_vocab_topics_level_slug", columnNames = {"jlpt_level", "slug"}),
            @UniqueConstraint(name = "UQ_vocab_topics_level_title_vi", columnNames = {"jlpt_level", "title_vi"})
        })
@Getter
@Setter
@NoArgsConstructor
